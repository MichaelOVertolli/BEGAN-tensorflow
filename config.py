...
net_arg.add_argument('--input_scale_size', type=int, default=28,
...
net_arg.add_argument('--z_num', type=int, default=256, choices=[32, 64, 128, 256])
...
train_arg.add_argument('--d_lr', type=float, default=0.000004)
train_arg.add_argument('--g_lr', type=float, default=0.00008)
train_arg.add_argument('--g_r_lr', type=float, default=0.00008)
train_arg.add_argument('--lr_lower_boundary', type=float, default=0.000002)
train_arg.add_argument('--beta1', type=float, default=0.5)
train_arg.add_argument('--beta2', type=float, default=0.999)
train_arg.add_argument('--gamma', type=float, default=0.9)
...
misc_arg.add_argument('--reverse', type=str2bool, default=False)
